...
const players_filter_dto_1 = require("./dto/players-filter.dto");
let PlayersController = class PlayersController {
    ...
    async updatePlayer(id, updatePlayerDto) {
        const updatedPlayer = await this.playersService.updatePlayer(id, updatePlayerDto);
        if (!updatedPlayer) {
            throw new common_1.NotFoundException('Player not found');
        }
...
__decorate([
    ...
    __metadata("design:paramtypes", [players_filter_dto_1.PlayersFilterDto]),
    __metadata("design:returntype", Promise)
], PlayersController.prototype, "getPlayersFromDatabase", null);
__decorate([
    (0, common_1.Get)('/:id'),
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], PlayersController.prototype, "deleteAllPlayers", null);
__decorate([
    (0, common_1.Patch)('/:id'),
    __param(0, (0, common_1.Param)('id')),
